...
let createArray = function () {
  let days = [ // Version sans le new Array avec directement les brackets
    'Lundi',
    'Mardi',
    'Mercredi',
    'Jeudi',
...
let changeSecondElement = function (array) {
  // array[1] = 'php'; // version simplifiée
...
let addAtFirst = function (array) {
  return array.valueOf(array.unshift('html', 'css')); // Version Pauline avec un valueOf pour afficher le resultat :)
}
...
let returnString = function (array) {
  // return array.join(); // version join 
  return array.toString(); // Methode plus adaptée à l'énoncé
}
